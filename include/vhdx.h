...
struct VHDX_FILE_IDENTIFIER {
    uint64_t	Signature;	// 0x656C696678646876
    uint16_t	Creator[256];
};

struct VHDX_HEADER {
    uint32_t	Signature;	// 0x64616568
    uint32_t	Checksum;
...
struct VHDX_LOG_ZERO_DESCRIPTOR {
    uint32_t	ZeroSignature;	// 0x6F72657A
    uint32_t 	Reserved;
    uint64_t	ZeroLength;
    uint64_t	FileOffset;
    uint64_t	SequenceNumber;
...
struct VHDX_LOG_DATA_DESCRIPTOR {
    uint32_t	DataSignature;	// 0x63736564
...
struct VHDX_LOG_DATA_SECTOR {
    uint32_t	DataSignature;	// 0x61746164
...
struct VHDX_METADATA_TABLE_HEADER {
    uint64_t	Signature;	// 0x617461646174656D
    uint16_t	Reserved;
    uint16_t	EntryCount;
